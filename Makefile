...
RandomFaultsKernel.o: RandomFaultsKernel.cu
...
tumorKinetics: RandomFaultsKernel.o main.o 
...
clean:
	rm -f tumorKinetics RandomFaultsKernel.o main.o 
	rm -rf ../../bin/$(TARGET_ARCH)/$(TARGET_OS)/$(BUILD_TYPE)/tumorKinetics
